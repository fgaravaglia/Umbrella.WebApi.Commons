...
namespace Umbrella.WebApi.Commons.Infrastructure.ErrorManagement
{
    ...
    /// </summary>
    public class InternalServerErrorActionResult : ObjectResult
    {
        /// <summary>
        /// Error repsonse
        /// </summary>
        ...
        public InternalServerErrorActionResult(string message, string trxId) : base(new ErrorResponse(message, trxId))
        {
